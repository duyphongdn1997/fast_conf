...
from os import path
import spacy
from src.model.utils import action_sequences_to_clusters
from src.model.entity_ranking_model import EntityRankingModel
from src.inference.tokenize_doc import tokenize_and_segment_doc
...
class Inference:
	def __init__(self, model_path, encoder_name=None):
		...
		self.basic_tokenizer = spacy.load("vi_core_news_lg")
