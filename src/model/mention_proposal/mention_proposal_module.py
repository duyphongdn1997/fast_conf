...
from src.model.document_encoder import IndependentDocEncoder
from src.pytorch_utils.modules import MLP

from src.model.mention_proposal.utils import sort_mentions
